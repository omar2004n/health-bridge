        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="table.html" class="nav-item nav-link"><i class="fa fa-calendar-check  me-2"></i>Appointment</a>
                    <a href="table.html" class="nav-item nav-link"><i class="fa fa-user me-2"></i> Patients</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                ...
                                <img class="rounded-circle" src="admin/img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                <div class="ms-2">
                                        <h6 class="fw-normal mb-0">omar send you a message</h6>
